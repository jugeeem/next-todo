...
- コード実装の提案と生成
- テストコードの作成（95%以上のカバレッジ維持）
- コードレビューと品質改善の提案
- ドキュメントの作成と更新
- バグ修正と機能追加の支援
- リファクタリングの提案
- Dev Containers環境のサポート

### 品質基準

- **テストカバレッジ**: 95%以上を維持（ステートメント・ライン基準）
...
- [ ] カバレッジが95%以上を維持しているか（ステートメント・ライン基準）
...
5. **テストカバレッジ95%以上**: テスト駆動開発を実践（ステートメント・ライン基準）
6. **型安全性を確保**: TypeScript の厳密な型チェック
7. **セキュリティを最優先**: 認証・認可・バリデーションを徹底
8. **Dev Containers 推奨**: VSCodeのDev Containersで開発環境を統一
